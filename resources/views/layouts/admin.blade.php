...
<head>
    ...
    <meta name="author" content="basiz" />
                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{ route('admin.index') }}" id="site-logo-inner">
                            <img class="" id="logo_header_1" alt="" src="{{ asset('assets/images/logo_2.png') }}"
                                data-light="{{ asset('assets/images/logo_2.png') }}" data-dark="{{ asset('assets/images/logo_2.png') }}">
                        </a>
